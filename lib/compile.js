      ...
      case "array":
        ...
        if(carg.count === 1) {
          if(dtypes[arrNum] === "generic") {
            if(carg.lvalue) {
              pre.push(["var l", arrNum, "=a", arrNum, ".get(", ptrStr, ")"].join(""))
              code = code.replace(re, "l"+arrNum)
              post.push(["a", arrNum, ".set(", ptrStr, ",l",arrNum,")"].join(""))
            } else {
              code = code.replace(re, ["a", arrNum, ".get(", ptrStr, ")"].join(""))
            }
          } else {
            code = code.replace(re, ["a", arrNum, "[", ptrStr, "]"].join(""))
          }
          ...
          pre.push(["var l", arrNum, "=a", arrNum, "[", ptrStr, "]"].join(""))
          code = code.replace(re, "l"+arrNum)
          if(carg.lvalue) {
            post.push(["a", arrNum, "[", ptrStr, "]=l",arrNum].join(""))
          }
        }
      break
      case "scalar":
